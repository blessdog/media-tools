...
const OUT = join(HERE, 'renders-ref');
...
const REFS = {
  s05: 'references/s05-SCENE-uso-inkwash-v1.png',
  s06: 'references/s06-FORESHADOW-uso-inkwash-v1.png',
  s37: 'references/s37-INSERT-uso-inkwash-v1.png',
  portrait: 'references/seedream-5-pro.png',
};
...
const STACK = {
  ...
  'ref+softwatercolor': 'krea2_softwatercolor.safetensors',
  'ref+linenscroll': 'chinese-ink-linen-scroll-comfy.safetensors',
};
