...
cd "$(dirname "$0")/../../.."
J=jobs/wang-meng
echo "==== restoring s-pine-over-bridge to the class swing" >&2
python3 $J/living/build-zone-living.py --zone z3w --stage cycle --classes foliage --region s-pine-over-bridge --keep-work > /dev/null
