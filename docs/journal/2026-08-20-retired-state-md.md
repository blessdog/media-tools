# The retired hand-written STATE.md (2026-08-13 → 2026-08-20)

*Moved here 2026-08-20, unedited. This is the NARRATIVE layer: what was tried,
what happened, in the order it happened. It is preserved because failures with
their mechanisms are the most valuable entries, and because forty dated entries
are a record no generated file can reconstruct.*

*What it is NOT any more: the place to look things up.* It reached 896
append-only lines and was three documents sharing a filename — claims, narrative
and status. Two of its numbered laws were re-derived at real cost on the last
day it existed, because a prose list is not queryable:

- **LAW 3, "Frame-zero control on every fill/extend: 0 px changed at rest"** —
  written 2026-08-17, re-derived 2026-08-20 after four wrong amplitude passes on
  a rig that was deleting 54% of a canopy. Now `knowledge/rest-is-a-noop.md`.
- **LAW 7, "click TRUNKS not canopies"** — written 2026-08-17, violated the same
  afternoon by prompting SAM on two leaf sprays and concluding SAM could not cut
  a tree. Now `knowledge/sam-click-trunks-not-canopies.md`.

Its claims are migrated into `knowledge/`, typed and retrieval-tested. Its status
is regenerated into `STATE.md` from the repo. This file keeps the story.
