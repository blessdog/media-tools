> **SUPERSEDED 2026-08-25 by `jobs/wang-meng/PLAN.md`. ARCHIVED, NOT DELETED —
> LAW #0.6.** Its live sections (two-jobs, the figures, the catalogue gap, the
> depth findings, the governing rule) were CARRIED FORWARD verbatim into the new
> PLAN.md. What died: the phase ORDER, which assumed RISE 4's shot list, and the
> "roughly three minutes / camera travels up from river to summit" end state,
> which Ryan retracted on 2026-08-25.
